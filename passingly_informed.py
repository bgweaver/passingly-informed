...
SYSTEM_PROMPT = (
    ...
    "- ONE line per team, and that line holds EVERYTHING about the team -- its "
    "record/standing, its recent result, its next game, AND its star player's "
    "stat -- in a single natural sentence. Never split one team across lines. "
    "Example: 'The Fever (9-6, third in the East) are in Atlanta today for a "
    "rematch, and Caitlin Clark's been scoring about 21 a game.' Keep it sounding "
    "like a sentence a person would say: choose the facts that matter and drop "
    "the least important if it gets crowded. One connected thought per team, not "
    "a stack of disconnected facts.\n"
