...
SYSTEM_PROMPT = (
    ...
    "- Keep a team's facts TOGETHER -- don't scatter one team across separate, "
    "disconnected lines the way a stat dump would. But a team carrying a lot "
    "(record, standing, last result, next game, a star's number) should BREATHE "
    "across one or two sentences, not get crammed into a single endless one. A "
    "natural split: the result and where they stand in one sentence, the next "
    "game and the star in another. Example: 'The Fever are 9-7, third in the "
    "East after a loss to the Dream last night. They're home against the Mercury "
    "tomorrow, with Caitlin Clark scoring about 21 a game.' Aim for at most two "
    "sentences per team; if it still feels heavy, drop the least important fact "
    "rather than stuffing it in. One connected thought, comfortably said aloud.\n"
