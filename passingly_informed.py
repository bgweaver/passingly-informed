...
SYSTEM_PROMPT = (
    ...
    "scorers', 'fourth in the league'), and never alongside a second number.\n\n"
    ...
    "never '20.79'). Say standings naturally ('third in the East', 'near the top "
    "of the East'), not 'third seed'. Never put two numbers in one line. If a "
    "line sounds like a box score, rewrite it as something a person would say.\n\n"
    "OUTPUT:\n"
    ...
    "compressed data point. Do NOT mash two things together (e.g. today's game "
    "AND last game). Whenever the facts give a concrete angle -- a title just "
    "won, an event hosted here, a team's story this season -- build the hatch "
    "around THAT as a curious handoff ('crazy the Knicks finally won one -- who "
